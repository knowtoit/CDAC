...
public class VehicleServiceImpl implements VehicleService {
	...
	@Override
	public boolean addNewVehicle(int ch) {
		...
		if(ch==1) {
			...
			v = new ElectricVehicle(vid, vname, price, status, batteryCapacity, chargingTime);
		...
		if(ch==2) {
			...
			System.out.println("Enter milaege");
			double mileage = sc.nextDouble();
			
			v = new PetrolVehicle(vid,vname, price, status, fuelType, mileage);
		}
	...
	public boolean updatePriceById(int id, double newPrice) {
		// TODO Auto-generated method stub
		return vdao.modifyPriceById(id, newPrice);
	}

	@Override
	public boolean sellVehicle(int id) {
		// TODO Auto-generated method stub
		return vdao.sellVehicleById(id);
	}
	...
	public boolean purchaseVehicle(int id) {
		// TODO Auto-generated method stub
		return vdao.purchaseVehicleById(id);
	}
	...
	@Override
	public Set<Vehicle> getVehiclesByType(int ch) {
		return vdao.findByType(ch);
	}

	@Override
	public Set<Vehicle> getVehiclesByPriceRange(double minPrice, double maxPrice) {
		return vdao.findByPriceRange(minPrice, maxPrice);
	}
